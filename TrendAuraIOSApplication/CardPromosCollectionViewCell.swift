//  CardPromosCollectionViewCell.swift
...
class CardPromosCollectionViewCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        cardTitleLabel.font = UIFont.Outfit_Medium(size: 10)
        
        cardSubTitleLabel.font = UIFont.Outfit_Regular(size: 8)
...
//        visitView.layer.borderColor = UIColor.white.cgColor
        ...
        visitLabel.font = UIFont.Outfit_Medium(size: 7)
        ...
        addCartLabel.font = UIFont.Outfit_Medium(size: 7)
        
        visitCountView.layer.cornerRadius = screenHeightFactor * 9
